...
# Generated by qmake (2.01a) (Qt 4.7.3) on: Wed Oct 31 13:59:39 2012
# Project:  Ray42.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/Ray421.0.0/ && $(COPY_FILE) --parents src/header/QtInclude.hpp src/header/Ray.hpp src/header/RayInclude.hpp src/header/RayStream.hpp src/header/RCamera.hpp src/header/RCylinder.hpp src/header/RObject.hpp src/header/RPlane.hpp src/header/RSphere.hpp src/header/RTransform.hpp .tmp/Ray421.0.0/ && $(COPY_FILE) --parents src/main.cpp src/Ray.cpp src/RayStream.cpp src/RCamera.cpp src/RCylinder.cpp src/RObject.cpp src/RPlane.cpp src/RSphere.cpp src/RTransform.cpp .tmp/Ray421.0.0/ && (cd `dirname .tmp/Ray421.0.0` && $(TAR) Ray421.0.0.tar Ray421.0.0 && $(COMPRESS) Ray421.0.0.tar) && $(MOVE) `dirname .tmp/Ray421.0.0`/Ray421.0.0.tar.gz . && $(DEL_FILE) -r .tmp/Ray421.0.0
